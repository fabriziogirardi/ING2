                ...
                ->schema([
                    Placeholder::make('relation_exists_info')
                        ...
                        ->content(function (Get $get) use ($config) {
                            ...
                            if (empty($personData)) return new HtmlString('');
            ...
            if ($data['soft_deleted_exists'] ?? false) {
                ...
                if ($deletedRelation) {
                    ...
                    $additionalData = array_filter(
                        $data,
                        function ($key) { return !in_array($key, ['person_id', 'person_found', 'relation_exists', 'soft_deleted_exists', 'person_data', 'email_search']); },
