<footer class="mt-auto">
    <div class="p-4 py-8 bg-white md:p-8 lg:p-10 ">
        <div class="mx-auto max-w-screen-xl text-center">
            ...
            <span class="block text-sm text-gray-500 dark:text-gray-400 md:col-span-3">© 2025 <a href="https://flowbite.com"
                                                                                   class="hover:underline">TAGS</a>. Todos los derechos reservados.</span>
        </div>
    </div>
    <div class="pt-16"></div>
</footer>
