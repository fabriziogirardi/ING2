    ...
    <section class="bg-white dark:bg-gray-900 rounded-lg shadow-md">
        <div class="container px-6 py-12 mx-auto lg:flex lg:items-center lg:gap-12">
            <div class="wf-ull lg:w-1/2">
                <p class="text-sm font-medium text-blue-500 dark:text-blue-400">{{ $code }}</p>
                <h1 class="mt-3 text-2xl font-semibold text-gray-800 dark:text-white md:text-3xl">{{ $title }}</h1>
            ...
            <div class="relative w-full mt-8 lg:w-1/2 lg:mt-0">
                <img class=" w-full lg:h-[32rem] h-92 md:h-96 rounded-lg object-cover " src="{{ $image }}" alt="">
            </div>
        </div>
    </section>
</x-layouts.minimal>
