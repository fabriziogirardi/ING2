            ...
            <div class="w-full place-self-center lg:col-span-6">
                <div class="p-6 mx-auto bg-white rounded-lg shadow sm:max-w-xl sm:p-8">
                    ...
                    <p class="text-sm font-light text-gray-500">
                        Ingrese los datos de la reserva para permitir su retiro
                    </p>
                    <form class="mt-4 space-y-6 sm:mt-6" action="{{ route('employee.reservation.retire.post') }}" method="POST" @submit="submit = true">
                        @csrf
