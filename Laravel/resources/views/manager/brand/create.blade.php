                    ...
                    <form class="mt-4 space-y-6 sm:mt-6" action="{{ route('manager.brand.store') }}" method="POST" @submit="submit = true">
                        ...
                        <div class="grid gap-6 sm:grid-cols-2">
                            <x-forms.input.text
                                name="name"
                                id="name"
                                label="{{ __('product/forms.brand_name') }}"
                        ...
                        <div class="flex items-center">
                            <x-forms.submit text="{{ __('product/forms.add_brand') }}" icon-left="fa-solid fa-plus" submit="true" full-width="true" type="success" />
                        </div>
                    </form>
                </div>
            </div>
